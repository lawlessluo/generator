...
public class ProviderUpsertSelectiveMethodGenerator extends AbstractJavaProviderMethodGenerator {

    public ProviderUpsertSelectiveMethodGenerator(boolean useLegacyBuilder) {
    ...
    public void addClassElements(TopLevelClass topLevelClass) {
        ...
        if (useLegacyBuilder) {
            ...
            staticImports.add("org.apache.ibatis.jdbc.SqlBuilder.UPSERT_INTO"); //$NON-NLS-1$
        ...
        method.addBodyLine(String.format("%sUPSERT_INTO(\"%s\");", //$NON-NLS-1$
                builderPrefix,
